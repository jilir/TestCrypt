...
{
    public partial class PageAnalyze : WizardPage
    {
        #region Constants
        ...
        public PageAnalyze(WizardPage previousPage)
        {
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            TrueCrypt.Password password = context.Password;
            ...
            for (int i = 0; (i < rangeList.Count) && !backgroundWorker.CancellationPending; i++)
            {
                ...
                while ((curLba <= range.EndLba) && !backgroundWorker.CancellationPending)
                {
                    ...
                    PhysicalDrive.Read(context.Drive.DriveNumber, curOffset, length, data);
